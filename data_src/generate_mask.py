...
def main():
    ...
    fig = make_subplots(rows=2, cols=2, subplot_titles=("Cloud", "Mask pc", "Mask", "Mask opened")) 
    fig.append_trace(go.Scatter(x=pc[:,0], y=pc[:,1], mode='markers', marker=dict(
        size=2,
    ...
    fig.append_trace(go.Scatter(x=indices[:,0], y=indices[:,1], mode='markers', marker=dict(
        size=4,
